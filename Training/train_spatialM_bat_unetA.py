...
if __name__ == "__main__":
    ...
    plt.ylabel('Loss')
    plt.legend()
    plt.savefig('/data1/xhou/ML_CVR/smooth8/ML_data/train/UnetA_corr_gl_mBold_spatialM_bat_aal_Epoch_200_valid_loss.png', dpi=300)
    plt.show()

    model_name = '/data1/xhou/ML_CVR/smooth8/ML_data/train/UnetA_corr_gl_mBold_spatialM_bat_aal_Epoch_200.pt'
    if torch.cuda.device_count() > 1:
