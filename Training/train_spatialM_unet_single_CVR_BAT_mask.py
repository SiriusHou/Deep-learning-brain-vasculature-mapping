        ...
        for subname in os.listdir(data_root):
            if os.path.isdir(os.path.join(data_root, subname)):
                for subfile in os.listdir(os.path.join(data_root, subname)):
                    if fnmatch.fnmatch(subfile, 'bold_spatialM_ce_nm_[0-2]*'):
...
if __name__ == "__main__":
    ...
    for t in range(epochs):
        ...
        if (t + 1) % 10 == 0:
            ...
            model_parts = ('/data1/xhou/ML_CVR/smooth8/ML_data/train/Unet_single_corr_beta0_spatialM_ce_nm_Epoch_', str(t+1) , '_AdaB1_1e12_final2_mask_soft_4.pt')
