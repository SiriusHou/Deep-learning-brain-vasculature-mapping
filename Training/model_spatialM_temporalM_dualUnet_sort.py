...
class DualUNet(nn.Module):
    def __init__(self, spatial_channels=10, temporal_channels=30, n_classes=1, padding=False, batch_norm=False, up_mode='upconv'):
        """
        Args:
        ...
        self.UNetBlockTemp = UNetBlock(in_channels=temporal_channels, n_classes=1, depth=5, wf=6, padding=padding, residue=False, batch_norm=False, up_mode='upconv')
