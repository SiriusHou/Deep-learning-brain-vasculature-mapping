...
import math
from model_spatialS_temporalM_unetA_avg3_ssim_sort import ChannelAttnUNet
...
if __name__ == "__main__":
    ...
    torch.save(model.state_dict(), 'd:\\xhou4\\ML_CVR\\smooth8\\ML_data\\parameter_spatialS_temporalM_unet_avg3_ssim_sort.pt')
