    ...
    for pod in range(5):
        ...
        for t in range(epochs):
            ...
            if (t + 1) % 10 == 0:
                ...
                model_parts = ('/data1/xhou/ML_CVR/smooth8/ML_data/cross-validate/', pod_test_name,'/Unet_single_corr_beta0_spatialM_ce_nm_Epoch_', str(t+1) , '_AdaB1_1e12_final2_mask_soft_4.pt')
        ...
        plt.ylabel('Loss')
        plt.legend()
        plt.savefig('/data1/xhou/ML_CVR/smooth8/ML_data/train/Unet_single_corr_bold0_spatialM_ce_nm_Epoch_100_valid_loss_CVR_BAT.png', dpi=300)
        plt.show()
