...
if __name__ == "__main__":
    ...
    model = UNet(in_channels=167, n_classes=1, depth=5, batch_norm=False, padding=True, up_mode='upconv')
    ...
    plt.ylabel('Loss')
    plt.legend()
    plt.savefig('/data1/xhou/ML_CVR/smooth8/ML_data/train/Unet_corr_gl_spatialM_aal_Epoch_200_valid_loss.png', dpi=300)
    plt.show()

    model_name = '/data1/xhou/ML_CVR/smooth8/ML_data/train/Unet_corr_gl_spatialM_aal_Epoch_200.pt'
    if torch.cuda.device_count() > 1:
