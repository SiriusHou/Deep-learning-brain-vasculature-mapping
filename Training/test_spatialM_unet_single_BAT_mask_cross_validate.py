...
if __name__ == "__main__":
    ...
    for pod in range(5):
        ...
        model_path = '/data1/xhou/ML_CVR/smooth8/ML_data/cross-validate/' + pod_test_name + '/Unet_single_BAT_corr_beta0_spatialM_ce_nm_Epoch_100_AdaB1_1e12_final2_mask_soft_4.pt'
        ...
        with torch.no_grad():
            for X_ID, X, X_affine in test_loader:
                ...
                nib.save(img_output, '_'.join([X_dir, 'ML_Unet_single_result_BAT.nii']))
        ...
        for subname in glob.glob('*/'):
            ...
            img_output.get_data_dtype() == np.dtype(np.int16)
            nib.save(img_output, os.path.join(test_dir, subname, 'ML_result_spatialM_ce_nm_Unet_single_BAT4_only.nii'))
