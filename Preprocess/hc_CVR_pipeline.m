...
function hc_CVR_pipeline(wkdir, folder_name)

% wkdir = 'L:\CVR_backup\smooth8\Park';
% addpath('L:\Lulab\rsCVR_PCA\Park\script_CO2');
% folder_name = '3T0807';
...
if exist([wkdir, filesep, folder_name, filesep, mpr_file_name, '_HC'])
    rmdir([wkdir, filesep, folder_name, filesep, mpr_file_name, '_HC'], 's');
end

if exist([wkdir, filesep, folder_name, filesep, 'CVR_globalshift'])
    rmdir([wkdir, filesep, folder_name, filesep, 'CVR_globalshift'], 's');
end
